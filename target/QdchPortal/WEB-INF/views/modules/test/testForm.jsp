	...
	<form:form id="inputForm" modelAttribute="test" action="${ctx}/test/test/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<input class="btn" type="button" value="客户端验证" onclick="top.$.jBox('iframe:${ctxStatic}/jquery-validation/1.11.0/demo/index.jsp',{title: '客户端验证',width: 950,height: 600,buttons: { '关闭': true }});"/>
			</div>
		</div>
