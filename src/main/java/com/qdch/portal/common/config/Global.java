...
public class Global {
	 ...
	 * 属性文件加载对象
	 */
	public static PropertiesLoader addressLoader = new PropertiesLoader("businessInfoAddress.properties");
	 ...
	 * 获取配置
	 * 
	 * @see ${getAddressConfig('adminPath')}
	 */
	public static String getAddressConfig(String key) {
		String value = map.get(key);
		if (value == null) {
			value = addressLoader.getProperty(key);
			map.put(key, value != null ? value : StringUtils.EMPTY);
		}
		return value;
	}
	...
	public static String getSaltkey() {
		return getConfig("saltkey");
	}

    /**
     * 获取企信寶工商的appkey
     */
    public static String getBusinessAppKey() {
        return getConfig("businessappkey");
    }
     ...
     * 获取企信工商信息查询的地址
     */
    public static String getBusinessInfoAddress(String address) {
        return getAddressConfig(address);
    }
